...
export class FlareParticles {
    ...
    constructor(scene: BABYLON.Scene, mesh: BABYLON.Mesh) {
        ...
        this.particleSystem.addColorGradient(0, new BABYLON.Color4(1, 0.9612, 0.5141, 0.0));
        this.particleSystem.addColorGradient(0.25, new BABYLON.Color4(0.9058, 0.7152, 0.3825, 1.0));
        this.particleSystem.addColorGradient(1.0, new BABYLON.Color4(0.6320, 0.0, 0.0, 0.0));
