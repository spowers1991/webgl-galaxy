...
export class OTypeSurfaceParticles {
    public particleSystem: BABYLON.ParticleSystem;

    constructor(scene: BABYLON.Scene, mesh: BABYLON.Mesh, diameter: number) {
        this.particleSystem = new BABYLON.ParticleSystem("surfaceParticles", getRandomNumberBetween(300, 800), scene);
        ...
        this.particleSystem.addColorGradient(0, new BABYLON.Color4(0.3773, 0.0930, 0.0266, 0.000025));


        this.particleSystem.minSize = getRandomNumberBetween(0.1 , 0.3);
        this.particleSystem.maxSize = getRandomNumberBetween(0.5 , 0.9);
