...
export class ATypeCoronaParticles {
    ...
    constructor(scene: BABYLON.Scene, mesh: BABYLON.Mesh, emitter: BABYLON.IParticleEmitterType, diameter: number) {
        ...
        this.particleSystem.addColorGradient(0, new BABYLON.Color4(0.7, 0.7, 1, getRandomNumberBetween(0.5, 0.75)));
        this.particleSystem.addColorGradient(0.75, new BABYLON.Color4(0, 0, 0, getRandomNumberBetween(0.5, 0.75)));
