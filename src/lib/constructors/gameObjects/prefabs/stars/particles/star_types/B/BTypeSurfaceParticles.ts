...
export class BTypeSurfaceParticles {
    ...
    constructor(scene: BABYLON.Scene, mesh: BABYLON.Mesh, diameter: number) {
        ...
        this.particleSystem.addColorGradient(0, new BABYLON.Color4(0.3773, 0.0930, 0.0266, 0.25));


        this.particleSystem.minSize = 0.1;
        this.particleSystem.maxSize = diameter * 0.3;
