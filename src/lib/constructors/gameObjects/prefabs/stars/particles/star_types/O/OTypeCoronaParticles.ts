...
export class OTypeCoronaParticles {
    ...
    constructor(scene: BABYLON.Scene, mesh: BABYLON.Mesh, emitter: BABYLON.IParticleEmitterType, diameter: number) {
        ...
        this.particleSystem.addColorGradient(0, new BABYLON.Color4(0.7, 0.7, 1, 0.055));
        this.particleSystem.addColorGradient(0.5, new BABYLON.Color4(0.7, 0.7, 1, 0.004));
        this.particleSystem.addColorGradient(0.75, new BABYLON.Color4(255, 255, 255, 0.03));

        this.particleSystem.minScaleX = getRandomNumberBetween(0.8, 3.5);
        this.particleSystem.minScaleY = getRandomNumberBetween(3, 60);
        this.particleSystem.maxScaleX = getRandomNumberBetween(0.8, 3.5);
