...
export class OTypeCoronaParticles {
    ...
    constructor(scene: BABYLON.Scene, mesh: BABYLON.Mesh, emitter: BABYLON.IParticleEmitterType, diameter: number) {
        ...
        this.particleSystem.addColorGradient(0.5, new BABYLON.Color4(0.7, 0.7, 1, getRandomNumberBetween(0.25, 0.75)));
        this.particleSystem.addColorGradient(0.75, new BABYLON.Color4(255, 255, 255, getRandomNumberBetween(0.25, 0.75)));
